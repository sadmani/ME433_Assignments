...
//                        message, strlen(message), USB_DEVICE_CDC_TRANSFER_FLAGS_DATA_COMPLETE);                
//                //If the character 'a' is sent, toggle LED2 on RB15
...
//////                    LATBbits.LATB7 = 1;
//////                    LATBbits.LATB14 = 1;
//////                    OC1RS = num1*(PR2+1)/100;
//////                    OC2RS = num2*(PR2+1)/100;
////                    if(num1 == 10000){
////                        LATBbits.LATB15 = 0;
//////                        LATBINV = 0b1000000000000000;
////                    }
...
////            if(_CP0_GET_COUNT()>2000000){
////                int len = 0;
////                //increment value of i to send a new value each time
//////                i++;
//////                sprintf(message,"%d\r\n",i);
////                sprintf(message,"%d %d\r\n",num1,num2);
//////                num1 = 2;
