...
void APP_Tasks ( void )
{
    ...
    short accels2[3]; // accelerations for the 3 axes

    short mags2[3]; // magnetometer readings for the 3 axes
    ...
    acc_read_register(OUT_X_L_M, (unsigned char *) mags2, 6);

    // read the temperature data. Its a right justified 12 bit two's compliment number

    acc_read_register(TEMP_OUT_L, (unsigned char *) &temp2, 2);    
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            if(appData.emulateMouse)
            {
                ...
                if(movement_length > 50)
                {
                    ...
                    x_scaled = (3*acc_x)/32000;
                    y_scaled = (3*acc_y)/32000;
